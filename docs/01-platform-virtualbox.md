# 01 — Platform: VirtualBox

The VirtualBox path (Tier 1 / getting started): create the component VMs and put the sensor interface in promiscuous mode on a bridge that carries your traffic.
