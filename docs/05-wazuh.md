# 05 — Wazuh (endpoints + vulnerabilities)

Install the Wazuh manager, deploy agents to your hosts, and enable vulnerability detection. This gives you host visibility and the vuln data the remediation reports rank.
...
>
> **Why it's shaped this way:** see the flagship post — The Foundation / Remediation.
