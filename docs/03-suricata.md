# 03 — Suricata (signature IDS)

Install Suricata, load rules, point it at the mirror, and ship alerts to Elasticsearch (via Filebeat). Expect a LOT of noise — that's normal and it's what the triage layer is for.
...
>
> **Why it's shaped this way:** see the flagship post — The Foundation / Signal-to-Noise.
